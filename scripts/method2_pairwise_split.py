...
add_means = True # True if you want the plot to have the means of the blocks
...
split_sum_cutoff = 15 # Number of splits that have to be present in a continuous block to calculate the mean of that section

if save_splits:
    split_save_file = "results/method2/{}_{}-{}.csv".format(data_file, block_sizes[0], block_sizes[-1])
if add_means:
    figure_save_file = "figures/method2/{}_{}-{}_{}_means.png".format(data_file, block_sizes[0], block_sizes[-1], plot_type)
else:
    figure_save_file = "figures/method2/{}_{}-{}_{}.png".format(data_file, block_sizes[0], block_sizes[-1], plot_type)
